...
class LoadModelInfer(object):
    ...
    def __init__(self):
        self.npz_root_path = "/home/model_and_data/copy_data_from_3090/wanjie/security_paper_all_experiment_cuda1/prompt_classification/get_all_attn/longchat-7B-Instruct-legal/legal_4_category_100"
        self.illness_model_path = "/home/model_and_data/copy_data_from_3090/wanjie/security_paper_all_experiment_cuda1/prompt_classification/get_all_attn/longchat-7B-Instruct-legal/best_resnet18_not_pca_illness_num_classes4.pt"

        # 输入 val csv
        self.val_csv_path = "/home/model_and_data/copy_data_from_3090/wanjie/security_paper_all_experiment_cuda1/prompt_classification/get_all_attn/legal_qa_csv/legal_qa_100.csv"

        # 输出：拷贝后的 npz 目录 + 预测结果 csv
        self.out_npz_root = "/home/model_and_data/copy_data_from_3090/wanjie/security_paper_all_experiment_cuda1/prompt_classification/get_all_attn/longchat-7B-Instruct-legal/infer_10_val"
        self.out_csv_path = "/home/model_and_data/copy_data_from_3090/wanjie/security_paper_all_experiment_cuda1/prompt_classification/get_all_attn/longchat-7B-Instruct-legal/infer_10_val.csv"
