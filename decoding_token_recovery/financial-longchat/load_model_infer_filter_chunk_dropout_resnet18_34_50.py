...
def main():
    freq_csv_path = "/home/model_and_data/copy_data_from_3090/wanjie/security_paper/decoding_classification/train_classification_for_decoding/split_train_val/financial_longchat_decoding_50_filtered.csv"
    val_csv_path = "/home/model_and_data/copy_data_from_3090/wanjie/security_paper/decoding_classification/train_classification_for_decoding/split_train_val/financial_longchat_decoding_50_filtered.csv"

    BIG_NPY_path = "/home/model_and_data/copy_data_from_3090/wanjie/security_paper/decoding_classification/get_all_attn_decoding/financial-longchat-decoding-128_attn_topk128.npy"
    CASEID_PATH_path = "/home/model_and_data/copy_data_from_3090/wanjie/security_paper/decoding_classification/get_all_attn_decoding/financial-longchat-decoding-128_attn_topk128_case_ids.npy"

    model_name = "resnet34"
    topk = 128
    prompt_token_num = 370
    dropout_p = 0.

    ckpt_dir = f"./financial-longchat-decoding_topk64_resnet34"
